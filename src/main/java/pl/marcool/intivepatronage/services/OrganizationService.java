...
public class OrganizationService {
    ...
    public Organization save(Organization organization) throws MyExceptions {
    ...
    public Organization update(String id, Organization organization) throws MyExceptions {
        if (organizationRepository.findById(organization.getName()).isPresent())
            throw new MyExceptions(400,
                    "{\"Error\":\"" + organization.getName() + " - already exist\"}");
